...
bot = telebot.TeleBot('7887877485:AAF_YWXedsK1Kag5sr25Pb-E7Q4Rz4fhWzA')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "💢 𝗢𝗡𝗟𝗬 𝗣𝗔𝗣𝗔 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 @PYSCHOxKINGYT 💢"
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "💢 𝗢𝗡𝗟𝗬 𝗔𝗗𝗠𝗜𝗡 𝗖𝗔𝗡 𝗨𝗦𝗘 𝗧𝗛𝗜𝗦 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 @PYSCHOxKINGYT 💢"
    bot.reply_to(message, response)
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 10:
                response = "❕𝗖𝗼𝗼𝗹𝗱𝗼𝘄𝗻 𝗶𝗻 𝗲𝗳𝗳𝗲𝗰𝘁 𝗽𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁 𝟭𝟬 𝘀𝗲𝗰𝗼𝗻𝗱𝘀❕"
                bot.reply_to(message, response)
                return
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                full_command = f"./soulfix {target} {port} {time} 1800"
...
def welcome_start(message):
    ...
    response = f"🔆 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗣𝗬𝗦𝗖𝗛𝗢 𝘅 𝗗𝗶𝗟𝗗𝗢𝗦™ 𝗕𝗢𝗧 🔆"
    bot.reply_to(message, response)
